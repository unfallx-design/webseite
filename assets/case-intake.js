...
const fields=[
 ...
 F('vehicleMake','Hersteller · D.1','vehicle',{max:60}),
 F('firstRegistration','Erstzulassung · B','vehicle',{type:'date',max:10}),
 F('hsn','Herstellerschlüssel · 2.1','vehicle',{max:4}),
 F('tsn','Typschlüssel · 2.2','vehicle',{max:10}),
