...
(() => {
  ...
  ].map((c,i)=>({id:c.id,number:c.number,companyId:company.id,companyName:company.name,status:c.status,version:1,createdAt:'2026-09-08T09:00:00.000Z',updatedAt:`2026-09-09T0${9-i}:00:00.000Z`,finance:null,intake:{vehicle:c.vehicle,plate:'DEMO',vin:'',accidentDate:'2026-09-07',location:c.location,owner:'Fiktiver Auftraggeber',ownerContact:'kunde@example.com',description:c.description,insurer:'Beispielversicherung',claimNumber:'BEISPIEL-'+(i+1),lawyerEmail:'',authority:true,shareWithLawyer:false}}));
  function read(path){
