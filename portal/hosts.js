...
const workspaces={partner:{origin:APP_ORIGIN,title:'Partner-Portal',roles:['partner']},admin:{origin:ADMIN_ORIGIN,title:'UNFALLX Dashboard',roles:['admin','appraiser']},mobile:{origin:MOBILE_ORIGIN,title:'Mobile Aufnahme',roles:['partner']}};
...
function hostPolicy(host,url){
 ...
 if(p==='/mobile'&&workspace!=='mobile')return {redirect:MOBILE_ORIGIN+'/portal'+u.search};
...
module.exports={APP_ORIGIN,ADMIN_ORIGIN,MOBILE_ORIGIN,PUBLIC_ORIGIN,REPORT_ORIGIN,workspaces,workspaceForHost,appPath,reportPath,hostPolicy,links};
